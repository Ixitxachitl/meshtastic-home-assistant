...
class SerialHalCommand(google.protobuf.message.Message):
    ...
    _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["data", b"data", "mode", b"mode", "pin", b"pin", "transaction_id", b"transaction_id", "type", b"type", "value", b"value"]
...
class SerialHalResponse(google.protobuf.message.Message):
    ...
    _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["data", b"data", "error", b"error", "result", b"result", "transaction_id", b"transaction_id", "value", b"value"]
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...
