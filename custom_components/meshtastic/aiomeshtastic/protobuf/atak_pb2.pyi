...
class GeoChat(google.protobuf.message.Message):
    ...
    _HasFieldArgType: typing_extensions.TypeAlias = typing.Literal["_lang", b"_lang", "_room_id", b"_room_id", "_to", b"_to", "_to_callsign", b"_to_callsign", "_voice_profile_id", b"_voice_profile_id", "lang", b"lang", "room_id", b"room_id", "to", b"to", "to_callsign", b"to_callsign", "voice_profile_id", b"voice_profile_id"]
    def HasField(self, field_name: _HasFieldArgType) -> builtins.bool: ...
    _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["_lang", b"_lang", "_room_id", b"_room_id", "_to", b"_to", "_to_callsign", b"_to_callsign", "_voice_profile_id", b"_voice_profile_id", "lang", b"lang", "message", b"message", "receipt_for_uid", b"receipt_for_uid", "receipt_type", b"receipt_type", "room_id", b"room_id", "to", b"to", "to_callsign", b"to_callsign", "voice_profile_id", b"voice_profile_id"]
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...
    _WhichOneofReturnType__lang: typing_extensions.TypeAlias = typing.Literal["lang"]
    _WhichOneofArgType__lang: typing_extensions.TypeAlias = typing.Literal["_lang", b"_lang"]
    _WhichOneofReturnType__room_id: typing_extensions.TypeAlias = typing.Literal["room_id"]
    _WhichOneofArgType__room_id: typing_extensions.TypeAlias = typing.Literal["_room_id", b"_room_id"]
    ...
    _WhichOneofReturnType__voice_profile_id: typing_extensions.TypeAlias = typing.Literal["voice_profile_id"]
    _WhichOneofArgType__voice_profile_id: typing_extensions.TypeAlias = typing.Literal["_voice_profile_id", b"_voice_profile_id"]
    @typing.overload
...
class AircraftTrack(google.protobuf.message.Message):
    ...
    _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["aircraft_type", b"aircraft_type", "category", b"category", "cot_host_id", b"cot_host_id", "flight", b"flight", "gps", b"gps", "icao", b"icao", "registration", b"registration", "rssi_x10", b"rssi_x10", "squawk", b"squawk"]
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...
...
class CotGeoPoint(google.protobuf.message.Message):
    ...
    _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["lat_delta_i", b"lat_delta_i", "lon_delta_i", b"lon_delta_i"]
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...
...
class Marker(google.protobuf.message.Message):
    ...
    _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["color", b"color", "color_argb", b"color_argb", "iconset", b"iconset", "kind", b"kind", "parent_callsign", b"parent_callsign", "parent_type", b"parent_type", "parent_uid", b"parent_uid", "readiness", b"readiness"]
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...
...
class RangeAndBearing(google.protobuf.message.Message):
    ...
    _HasFieldArgType: typing_extensions.TypeAlias = typing.Literal["anchor", b"anchor"]
    def HasField(self, field_name: _HasFieldArgType) -> builtins.bool: ...
    _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["anchor", b"anchor", "anchor_uid", b"anchor_uid", "bearing_cdeg", b"bearing_cdeg", "range_cm", b"range_cm", "stroke_argb", b"stroke_argb", "stroke_color", b"stroke_color", "stroke_weight_x10", b"stroke_weight_x10"]
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...
...
class Route(google.protobuf.message.Message):
    ...
    class Link(google.protobuf.message.Message):
        ...
        _HasFieldArgType: typing_extensions.TypeAlias = typing.Literal["point", b"point"]
        def HasField(self, field_name: _HasFieldArgType) -> builtins.bool: ...
        _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["callsign", b"callsign", "link_type", b"link_type", "point", b"point", "uid", b"uid"]
        def ClearField(self, field_name: _ClearFieldArgType) -> None: ...
    ...
    _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["direction", b"direction", "links", b"links", "method", b"method", "prefix", b"prefix", "stroke_weight_x10", b"stroke_weight_x10", "truncated", b"truncated"]
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...
...
class ZMistEntry(google.protobuf.message.Message):
    ...
    _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["i", b"i", "m", b"m", "s", b"s", "t", b"t", "title", b"title", "z", b"z"]
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...
...
class EmergencyAlert(google.protobuf.message.Message):
    ...
    _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["authoring_uid", b"authoring_uid", "cancel_reference_uid", b"cancel_reference_uid", "type", b"type"]
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...
...
class TaskRequest(google.protobuf.message.Message):
    ...
    _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["assignee_uid", b"assignee_uid", "note", b"note", "priority", b"priority", "status", b"status", "target_uid", b"target_uid", "task_type", b"task_type"]
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...
...
class TAKEnvironment(google.protobuf.message.Message):
    ...
    _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["temperature_c_x10", b"temperature_c_x10", "wind_direction_deg", b"wind_direction_deg", "wind_speed_cm_s", b"wind_speed_cm_s"]
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...
...
class SensorFov(google.protobuf.message.Message):
    ...
    _HasFieldArgType: typing_extensions.TypeAlias = typing.Literal["_range_m", b"_range_m", "range_m", b"range_m"]
    def HasField(self, field_name: _HasFieldArgType) -> builtins.bool: ...
    _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["_range_m", b"_range_m", "azimuth_deg", b"azimuth_deg", "elevation_deg", b"elevation_deg", "fov_horizontal_deg", b"fov_horizontal_deg", "fov_vertical_deg", b"fov_vertical_deg", "model", b"model", "range_m", b"range_m", "roll_deg", b"roll_deg", "type", b"type"]
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...
    _WhichOneofReturnType__range_m: typing_extensions.TypeAlias = typing.Literal["range_m"]
    _WhichOneofArgType__range_m: typing_extensions.TypeAlias = typing.Literal["_range_m", b"_range_m"]
...
class TakTalkMessage(google.protobuf.message.Message):
    ...
    _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["chatroom_id", b"chatroom_id", "from_voice", b"from_voice", "lang", b"lang", "text", b"text"]
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...
...
class TakTalkRoomData(google.protobuf.message.Message):
    ...
    _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["participants", b"participants", "room_id", b"room_id", "room_name", b"room_name", "sender_callsign", b"sender_callsign"]
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...
...
class Marti(google.protobuf.message.Message):
    ...
    _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["dest_callsign", b"dest_callsign"]
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...
...
class TAKPacketV2(google.protobuf.message.Message):
    ...
    _HasFieldArgType: typing_extensions.TypeAlias = typing.Literal["_environment", b"_environment", "_marti", b"_marti", "_sensor_fov", b"_sensor_fov", "aircraft", b"aircraft", "casevac", b"casevac", "chat", b"chat", "emergency", b"emergency", "environment", b"environment", "marker", b"marker", "marti", b"marti", "payload_variant", b"payload_variant", "rab", b"rab", "raw_detail", b"raw_detail", "route", b"route", "sensor_fov", b"sensor_fov", "shape", b"shape", "taktalk", b"taktalk", "taktalk_room", b"taktalk_room", "task", b"task"]
    def HasField(self, field_name: _HasFieldArgType) -> builtins.bool: ...
    _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["_environment", b"_environment", "_marti", b"_marti", "_sensor_fov", b"_sensor_fov", "aircraft", b"aircraft", "alt_src", b"alt_src", "altitude", b"altitude", "battery", b"battery", "callsign", b"callsign", "casevac", b"casevac", "chat", b"chat", "cot_type_id", b"cot_type_id", "cot_type_str", b"cot_type_str", "course", b"course", "device_callsign", b"device_callsign", "emergency", b"emergency", "endpoint", b"endpoint", "environment", b"environment", "geo_src", b"geo_src", "how", b"how", "latitude_i", b"latitude_i", "longitude_i", b"longitude_i", "marker", b"marker", "marti", b"marti", "payload_variant", b"payload_variant", "phone", b"phone", "rab", b"rab", "raw_detail", b"raw_detail", "remarks", b"remarks", "role", b"role", "route", b"route", "sensor_fov", b"sensor_fov", "shape", b"shape", "speed", b"speed", "stale_seconds", b"stale_seconds", "tak_device", b"tak_device", "tak_os", b"tak_os", "tak_platform", b"tak_platform", "tak_version", b"tak_version", "taktalk", b"taktalk", "taktalk_room", b"taktalk_room", "task", b"task", "team", b"team", "uid", b"uid"]
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...
    _WhichOneofReturnType__environment: typing_extensions.TypeAlias = typing.Literal["environment"]
    _WhichOneofArgType__environment: typing_extensions.TypeAlias = typing.Literal["_environment", b"_environment"]
    _WhichOneofReturnType__marti: typing_extensions.TypeAlias = typing.Literal["marti"]
    _WhichOneofArgType__marti: typing_extensions.TypeAlias = typing.Literal["_marti", b"_marti"]
    _WhichOneofReturnType__sensor_fov: typing_extensions.TypeAlias = typing.Literal["sensor_fov"]
    _WhichOneofArgType__sensor_fov: typing_extensions.TypeAlias = typing.Literal["_sensor_fov", b"_sensor_fov"]
    _WhichOneofReturnType_payload_variant: typing_extensions.TypeAlias = typing.Literal["chat", "aircraft", "raw_detail", "shape", "marker", "rab", "route", "casevac", "emergency", "task", "taktalk", "taktalk_room"]
    _WhichOneofArgType_payload_variant: typing_extensions.TypeAlias = typing.Literal["payload_variant", b"payload_variant"]
    @typing.overload
